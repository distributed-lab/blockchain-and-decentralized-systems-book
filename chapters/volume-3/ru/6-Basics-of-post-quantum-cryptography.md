...
> _Note. Замечание. Ученые из Google AI заметили закономерность (т. н. закон Невена) [104], что квантовые компьютеры наращивают вычислительную мощность с двойной экспоненциальной скоростью._
> 
