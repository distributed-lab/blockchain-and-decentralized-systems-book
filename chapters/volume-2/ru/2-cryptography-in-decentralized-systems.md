...
Листья дерева представляют собой хэш-значения от произвольных данных (Data). Каждый из листьев и узлов одного дерева равен по размеру, и этот размер зависит от используемой хэш-функции. Количество листьев в дереве Меркла определяется значением 2h, где h – высота дерева Меркла (на рисунке высота дерева Меркла равна 2).
...
По этой причине нам необходимо построить полином степени t − 1, если мы хотим, чтобы секрет можно было восстановить при наличии t частей.
